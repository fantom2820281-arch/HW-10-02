...
но при выполнении проверки существования понимал что их уже нет 
...
при подключению к Redis  не забываем пароль, без авторизации база не работает 

```
docker exec -it redis_lab redis-cli -a redis123
```
